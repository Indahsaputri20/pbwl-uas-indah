        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(url('/transaksi/' .$row->transaksi_id)); ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="">KAPSTER</label>
                        <input type="text" name="transaksi_kapster" class="form-control" value="<?php echo e($row->transaksi_kapster); ?>">
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI3\pbwl-uas-indah\resources\views/transaksi/edit.blade.php ENDPATH**/ ?>