            ...
            <div class="card-body">
                <form action="<?php echo e(url('/transaksi')); ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="transaksi_kapster" class="form-control" placeholder="Kapster">
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI3\pbwl-uas-indah\resources\views/transaksi/create.blade.php ENDPATH**/ ?>